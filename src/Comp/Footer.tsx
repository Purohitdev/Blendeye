...
export default function Footer() {
    return (
        <div className="bg-[rgb(42,42,42)] text-white font-sans px-16 relative">
          ...
          <img src={waveSrc} alt="wave" className="w-1/2 object-cover block" />
            ...
            <div className="text-center py-20">
                <h1 className="text-4xl md:text-7xl font-medium leading-tight">
                    Let us take care of <br /> <span className="ml-52">your design needs</span>
                </h1>
                <button className="mt-8 px-4 py-3 bg-white text-black rounded-full font-medium hover:bg-gray-200 transition">
                    Start right now
                </button>
            </div>

            {/* Footer Content */}
            <div className="px-8 py-16 border-t border-white flex flex-col md:flex-row justify-between items-start">
                {/* Logo */}
                <div className="text-5xl font-bold mb-6 md:mb-0">BlendEye</div>
                ...
                <div className="min-h-[30vh] flex flex-col justify-between gap-10 w-full md:w-[50%]">
                    ...
                    <div className="flex gap-4">
                        {[
                            ...
                            <div
                                key={idx}
                                className="bg-white text-black rounded-xl px-6 py-4 flex flex-col items-start justify-between w-56  h-52 shadow hover:shadow-md transition"
                            >
            ...
            {/* Copyright */}
            <div className="text-center text-sm text-gray-400 py-6 flex items-center justify-between">
